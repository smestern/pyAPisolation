...
class AnalysisController(QObject):
    ...
    batch_progress = Signal(int, int)          # (completed, total) for status bar
    ...
    def _run_individual_legacy(self, module_name, params, sweeps, show_rejected):
        ...
        from gigaseal.featureExtractor import analyze_subthres
    ...
    def _legacy_spike_individual(self, params, sweeps, show_rejected):
        ...
        from gigaseal.featureExtractor import determine_rejected_spikes
    ...
    def _run_batch_legacy(self, folder, module_name, params, protocol_filter, output_tag):
        ...
        try:
            if module_name in ("spike", "peak_detector"):
                from gigaseal.featureExtractor import process_file, save_data_frames
                ...
                from gigaseal.featureExtractor import (
