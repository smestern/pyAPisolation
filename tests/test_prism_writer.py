...
def test_prism_writer():
    ...
    df_3way_rowcols = file.to_dataframe('3way_rowcols')
    print(df_3way_rowcols.head(15))

    out = file.make_group_table('1way_rowcols', test_df, cols='Sag Ratio', groupby='Burst Cadex')
