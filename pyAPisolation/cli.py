"""
pyAPisolation unified command-line interface.
...
``pyAPisolation.analysis`` framework — any registered ``AnalysisBase``
...
--------
    pyapisolation list
    pyapisolation run subthreshold data/ --output results/
    pyapisolation spike data/demo_data_1.abf --dv-cutoff 10
    pyapisolation gui spike-finder
    pyapisolation web-viz --data_folder data/
"""
...
# break ``pyapisolation --help``.
# ======================================================================

_GUI_LAUNCHERS: Dict[str, Dict[str, str]] = {
    "spike-finder": {
        "module": "pyAPisolation.gui.spikeFinder",
        "attr": "main",
        "desc": "Spike detection GUI (legacy spikeFinder)",
    },
    "new-spike-finder": {
        "module": "pyAPisolation.gui.app",
        "attr": "main",
        "desc": "Next-generation spike finder GUI",
    },
    "database-builder": {
        "module": "pyAPisolation.gui.databaseBuilder",
        "attr": "run",
        "desc": "Database builder GUI",
    },
    "csv-editor": {
        "module": "pyAPisolation.gui.csvExcelEditor",
        "attr": "main",
        "desc": "CSV / Excel editor GUI",
    },
    "analysis-wizard": {
        "module": "pyAPisolation.gui.postAnalysisRunner",
        "attr": "main",
        "desc": "Post-hoc analysis wizard GUI",
    },
    "prism-writer": {
        "module": "pyAPisolation.dev.prism_writer_gui",
        "attr": "PrismWriterGUI",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="pyapisolation",
        description="pyAPisolation — electrophysiology analysis toolkit",
    ...
    sub.required = False  # allow bare `pyapisolation` to print help
...
def _cmd_run_module(args: argparse.Namespace, module_name: str) -> int:
    ...
    if module is None:
        print(f"error: unknown module '{module_name}'. "
              f"Use `pyapisolation list` to see registered modules.",
              file=sys.stderr)
        return 2
...
def _cmd_gui(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        print(
            ...
            f"Install the GUI extras with: pip install 'pyAPisolation[gui]'",
            file=sys.stderr,
        )
        return 1
...
def _cmd_web_viz(args: argparse.Namespace) -> int:
    try:
        ...
        print(
            ...
            f"Install web extras with: pip install 'pyAPisolation[web]'",
            file=sys.stderr,
        )
        return 1
